...
<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <form role="form" method="POST" action="{{action('CustomerController@addcutomer')}}" enctype="multipart/form-data">
                        @csrf 
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="name" placeholder="Artisanal kale"
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label text-right">Shop
                                        Name</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="shop_name" placeholder="AKG Stors"
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="email" name="email"
                                            placeholder="uStart@example.com" id="example-email-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="tel" name="telephone"
                                            placeholder="0112 152 152" id="example-tel-input">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="address"
                                            placeholder="No:25 , Sir James Pieris Mawatha , Colombo"
                                            id="example-text-input">
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    <label for="example-password-input"
                                        class="col-sm-2 col-form-label text-right">Password Confirm</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="province" placeholder="Western"
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="district" placeholder="Colombo"
                                            id="example-text-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" name="city" placeholder="Maharagama"
                                            id="example-text-input">
                                    </div>
                                </div>
