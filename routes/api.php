...
Route::get('status','AttendenceController@status');
...
//current Location
Route::get('currentlocation','LocationController@currentlocation');
Route::get('savelatlng','LocationController@savelatlng');
